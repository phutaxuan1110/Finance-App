...
export function EditBudgetSheet({ open, onClose, month, year }: EditBudgetSheetProps) {
  ...
  async function handleSave() {
    ...
    try {
      ...
      showToast(err instanceof Error ? err.message : "Không thể lưu giới hạn. Vui lòng thử lại.", "error");
    }
  }
  ...
  async function handleRemove() {
    ...
    try {
      ...
      showToast(err instanceof Error ? err.message : "Không thể xoá giới hạn. Vui lòng thử lại.", "error");
    }
  }
